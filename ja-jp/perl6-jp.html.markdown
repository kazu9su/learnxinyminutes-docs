...
Perl 6は、少なくとも今後100年間使われるために作られた、
とても有能で、多機能なプログラム言語です。

基本的なPerl 6 のコンパイラは[Rakudo](http://rakudo.org)と呼ばれ、
JVM、または[the MoarVM](http://moarvm.com)上で動作します。

メタ情報 : "#"記号は3つでヘッドラインを、2つで節を、1つでメモを表します
